...
# [OUTPUT]: 导出 PATH / CHROMIUM_SRC / SAMO_OUT / CHROMIUM_VERSION，供 scripts/*.sh 与手工 gn/autoninja 使用（source samo-chromium/env.sh）
...
export CHROMIUM_VERSION="${CHROMIUM_VERSION:-152.0.7977.83}" # 钉住的上游版本（Stable，2026-09）；升版 = 改这里 + rebase 补丁
