...
- 2026-09-04 20:29：Samo AI 药丸（浮在网页之上的子 widget）与子 widget 命令路由落地；补丁 0001–0014。
- 下一步：对话浮窗形态、⌘I → agent 光标层 → 下载/查找/历史投影到壳 → 打包（official build、签名公证）与更新器 → 抽共享核心消 apps/workspace 两份逻辑。
