/**
 * [INPUT]: 依赖 react 的 useEffect/useRef，依赖 ogl 的 Renderer/Program/Mesh/Triangle
 * [OUTPUT]: 对外提供 Ferrofluid 组件——全屏 WebGL 铁磁流体着色器背景（含鼠标交互）
 * [POS]: components 的背景渲染器，铺在 App 最底层，承托中央文字
