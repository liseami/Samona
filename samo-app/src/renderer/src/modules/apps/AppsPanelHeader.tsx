/**
 * [INPUT]: 依赖 @shared/url 的 displayUrl，../../icons 的 Globe，./AppLogo，../../store/browser 的 useBrowser/send，../../components/ui/{button,tooltip}，../../shell/PanelHeader，../browser/NavButtons
