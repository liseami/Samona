/**
 * [INPUT]: 依赖 react，@dnd-kit/core（DndContext/DragOverlay/sensors），../../store/browser，../../lib/dnd 的解析与碰撞检测，./{Omnibox,AgentBanner,FavoritesGrid,PinnedGrid,TabList,IdentityBar,IdentityEditor,DragGhost}，./useSpaceSwipe
