/**
 * [INPUT]: 依赖 ../../icons 的 Plus，../../store/browser 的 useBrowser/send/selectActiveIdentity/selectActiveTab，../../components/ui/{button,kbd}
 * [OUTPUT]: 对外提供 BrowserPanel 组件：浏览器模块的面板——有活动标签时渲染空（网页视图叠在面板上），否则显示身份空态（New Tab 开命令面板）
