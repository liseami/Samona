/**
 * [INPUT]: 依赖 ../../shell/ContentHole 的 ContentHole， ../../icons 的 Plus，../../store/browser 的 useBrowser/send/selectActiveTab，../../components/ui/{button,kbd}，./TabOverview
...
export function BrowserPanel() {
  ...
  if (activeTab) return <ContentHole />; // 网页视图落在这里：量矩形交给宿主
  return (
    <div className="flex h-full w-full flex-col items-center justify-center px-6 py-12 text-center">
      <div className="mb-2 text-lg font-medium text-foreground">Nothing open</div>
      <div className="mb-5 max-w-80 text-sm leading-relaxed text-muted-foreground">Open something to get started.</div>
