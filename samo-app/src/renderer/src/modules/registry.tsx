/**
 * [INPUT]: 依赖 react 的 ComponentType，@shared/model 的 ModuleId，./browser/{sidebar/BrowserSidebar,BrowserPanel,BrowserPanelHeader}，./apps/{AppsSidebar,AppsPanel,AppsPanelHeader}，./placeholder/Placeholder
