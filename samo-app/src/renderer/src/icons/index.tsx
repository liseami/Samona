/**
 * [INPUT]: 依赖 react，./pika/index.js（Laper 的 Pika 图标库，1200+ 描边图标，API: size/color/className/ariaLabel）
 * [OUTPUT]: 对外提供壳所需图标的语义命名（SidebarClose/SidebarOpen/ArrowLeft/ArrowRight/Refresh/Close/Plus/Lock/Search/Window/Clock/Globe/Bot/Hand/Spinner/VolumeOn/VolumeMute/ChevronRight/Folder/FolderOpen/Eraser/Bug/Settings/Download）与 IconProps 类型；全部以装饰性（aria-hidden）渲染，按钮的可访问名由文字/aria-label 决定
