 ...
 * [OUTPUT]: 对外提供 IconPoland 国旗图标组件
 * [POS]: shared/pika-icons/flags 的波兰语语言选择器图标，被 SUPPORTED_LANGUAGES.flagIcon 引用
 * [PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
 */
import React from 'react';

// 波兰国旗 · 与 IconChina 同规格: 32 viewBox + 30x24 旗面
const IconPoland = ({ size = '32px', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 32 32" fill="none" {...props}>
    <defs>
      <clipPath id="laper-flag-poland">
        <rect x="1" y="4" width="30" height="24" rx="4" ry="4" />
      </clipPath>
    </defs>
    <g clipPath="url(#laper-flag-poland)">
      <rect x="1" y="4" width="30" height="12" fill="#F5F5F5" />
      <rect x="1" y="16" width="30" height="12" fill="#D80027" />
    </g>
