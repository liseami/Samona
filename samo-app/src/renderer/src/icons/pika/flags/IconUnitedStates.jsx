 ...
 * [OUTPUT]: 对外提供 IconUnitedStates 国旗 SVG 组件
 * [POS]: shared/pika-icons/flags 的美国国旗，供语言切换器 (SUPPORTED_LANGUAGES.flagIcon) 消费
 * [PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
 */

import React from "react";

function IconUnitedStates({ size = "32px", ...props }) {
  return (
    <svg
