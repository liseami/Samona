...
export default function PiArrowRightSquareStroke({ 
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12.051 16a20.3 20.3 0 0 0 3.807-3.604A.63.63 0 0 0 16 12m-3.949-4a20.3 20.3 0 0 1 3.807 3.604A.63.63 0 0 1 16 12m0 0H8m4 9c-2.796 0-4.193 0-5.296-.457a6 6 0 0 1-3.247-3.247C3 16.194 3 14.796 3 12s0-4.193.457-5.296a6 6 0 0 1 3.247-3.247C7.807 3 9.204 3 12 3s4.194 0 5.296.457a6 6 0 0 1 3.247 3.247C21 7.807 21 9.204 21 12s0 4.194-.457 5.296a6 6 0 0 1-3.247 3.247C16.194 21 14.796 21 12 21Z" fill="none"/>
    </svg>
  );
}
