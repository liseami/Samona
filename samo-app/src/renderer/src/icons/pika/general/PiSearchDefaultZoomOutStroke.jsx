...
export default function PiSearchDefaultZoomOutStroke({ 
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m21 21-6.05-6.05m0 0a7 7 0 1 0-9.9-9.9 7 7 0 0 0 9.9 9.9ZM7 10h6" fill="none"/>
    </svg>
  );
}
